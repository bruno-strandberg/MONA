...
void SplitEnergy() {
  ...
  DetResponse drgt(DetResponse::hybridE, "track_response_gt", 40, 1, 100, 40, -1, 1, 1, 0, 1);
  ...
  drgt.AddCut( &SummaryEvent::Get_RDF_track_score , std::greater<double>()   ,  0.6, true );
  ...
  DetResponse drgs(DetResponse::hybridE, "track_response_gs", 40, 1, 100, 40, -1, 1, 1, 0, 1);
  ...
  drgs.AddCut( &SummaryEvent::Get_RDF_track_score , std::greater<double>()   ,  0.6, true );
  ...
  DetResponse drge(DetResponse::hybridE, "track_response_ge", 40, 1, 100, 40, -1, 1, 1, 0, 1);
  ...
  drge.AddCut( &SummaryEvent::Get_RDF_track_score , std::greater<double>()   ,  0.6, true );
  ...
  DetResponse drs(DetResponse::hybridE, "shower_response", 40, 1, 100, 40, -1, 1, 1, 0, 1);
  ...
  DetResponse drm(DetResponse::mc_truth, "mc_response", 40, 1, 100, 40, -1, 1, 1, 0, 1);
  ...
  drgt.WriteToFile(filefolder + "track_response_gt.root");
  drgs.WriteToFile(filefolder + "track_response_gs.root");
  drge.WriteToFile(filefolder + "track_response_ge.root");
  drs.WriteToFile(filefolder  + "shower_response.root");
  drm.WriteToFile(filefolder  + "mc_response.root");

//  drgt.ReadFromFile(filefolder + "track_response.root");
//  drgs.ReadFromFile(filefolder + "track_response.root");
//  drge.ReadFromFile(filefolder + "track_response.root");
//  drs.ReadFromFile(filefolder  + "shower_response.root");
//  drm.ReadFromFile(filefolder  + "mc_response.root");
  ...
  FitFunction gtfitf(&drgt, 3, "../data/eff_mass/EffMhists_elec_CC.root", "../data/eff_mass/EffMhists_muon_CC.root", "../data/eff_mass/EffMhists_tau_CC.root", "../data/eff_mass/EffMhists_elec_NC.root");
  FitFunction gsfitf(&drgs, 3, "../data/eff_mass/EffMhists_elec_CC.root", "../data/eff_mass/EffMhists_muon_CC.root", "../data/eff_mass/EffMhists_tau_CC.root", "../data/eff_mass/EffMhists_elec_NC.root");
  FitFunction gefitf(&drge, 3, "../data/eff_mass/EffMhists_elec_CC.root", "../data/eff_mass/EffMhists_muon_CC.root", "../data/eff_mass/EffMhists_tau_CC.root", "../data/eff_mass/EffMhists_elec_NC.root");
  ...
  TH3D *hdet_good_t  = (TH3D*)drgt.GetHist3D()->Clone("detected_tracks_gt"); // Track channel, using good tracks, etc.
  TH3D *hdet_good_s  = (TH3D*)drgs.GetHist3D()->Clone("detected_tracks_gs");
  TH3D *hdet_good_e  = (TH3D*)drge.GetHist3D()->Clone("detected_tracks_ge");
  ...
  for (auto order: orderings) {
    ...
    TString output = Form("split_energy_%s.root", order_string.c_str());
