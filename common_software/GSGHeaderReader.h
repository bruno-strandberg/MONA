...
/** A ROOT-generated class to parse gSeaGen header in ROOT files.
 *
 *  This class is automatically generated by doing Header->MakeClass() after opening 
 *  a gSeaGen output in root format. This class is used only in GSGReader.h to get some
 *  variables for effective mass/area calculation. Some minor changes in the constructor.
