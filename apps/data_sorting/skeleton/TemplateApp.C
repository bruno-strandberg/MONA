...
int main(const int argc, const char **argv) {
  ...
  try {
    ...
    JParser<> zap("This program takes the ECAP PID summary file as input, reading it with NEWREADERCLASS.h/C class, and converts it to `SummaryEvent` format for usage with NMH software.");
