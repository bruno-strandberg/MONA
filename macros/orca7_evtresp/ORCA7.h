...
struct ORCA7 {
  ...
  Double_t f_T_emin  = 1.0;
  Double_t f_T_emax  = 100.0;
  Double_t f_T_ctmin = -1.0;
  Double_t f_T_ctmax = -1e-3;
  Double_t f_T_bymin = 0.0;
  Double_t f_T_bymax = 1.0;

  vector< O7::PidBinConf > fPidBins;
  std::map< TString, EvtResponse*> fResps;
  ...
  Double_t f_F_runtime = 1.0;
  Double_t f_F_emin    = 1.0;
  Double_t f_F_emax    = 100.;
  Double_t f_F_ctmin   = -1.0;
