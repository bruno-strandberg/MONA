...
void Plot_Compare_Single_Asymmetry_Half_Data_NBins() {
...
//  gStyle->SetOptStat(0);
    ...
    TH1D *h_t_gt_out = std::get<0>(ErrorPlotWithHalfData(h_t_all, h_t_gt, h_t_lt));
    h_t_gt_out->SetName(TString::Format("h_t_gt_%i", i));
    TH1D *h_t_lt_out = std::get<1>(ErrorPlotWithHalfData(h_t_all, h_t_gt, h_t_lt));
    h_t_lt_out->SetName(TString::Format("h_t_lt_%i", i));

    TH1D *h_s_gt_out = std::get<0>(ErrorPlotWithHalfData(h_s_all, h_s_gt, h_s_lt));
    h_s_gt_out->SetName(TString::Format("h_s_gt_%i", i));
    TH1D *h_s_lt_out = std::get<1>(ErrorPlotWithHalfData(h_s_all, h_s_gt, h_s_lt));
