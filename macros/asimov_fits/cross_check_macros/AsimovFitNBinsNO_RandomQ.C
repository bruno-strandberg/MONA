...
void AsimovFitNBinsNO_RandomQ() {
  ...
  TString s_outputfile = TString::Format("output/csv/CrossCheck/random_q/AsimovFitNBinsNO_RandomQ_Dist_ERange3-20_Rand%ibins.csv", N_PID_CLASSES);
