...
void AsimovFitSeperateTh23Range() {

  TString s_filefolder = "./";
  TString s_outputfile = "output/csv/AsimovFitSeperateTh23Range.txt";
  ...
  for (Int_t i = 0; i < 11; i++) {
    Double_t th23 = 40 + i;
    Double_t sinSqTh23 = TMath::Power(TMath::Sin(th23 * TMath::Pi()/180.), 2);
