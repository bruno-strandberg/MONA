...
void FitOverEstimation2Bins() {
  ...
  tree_out.ReadFile(MONADIR + "./output/csv/CrossCheck/percentages/AsimovFitNO_PercentageOfMC/AsimovFitNO_PercentageOfMC_0-99.csv", 
...
//  file_in.Close(); // Close the file so that RooFit can make plots on screen. (bug?)
  ...
  tree_in->ReadFile(MONADIR + "./output/csv/CrossCheck/percentages/AsimovFitNO_PercentageOfMC/AsimovFitNO_PercentageOfMC_0-99.csv", 
                     "percentage/D:Ebins/I:ctBins/I:n_chi2tr_no/D:n_chi2sh_no/D:fit_chi2/D", ',');
