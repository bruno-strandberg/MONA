...
void FitOverEstimationCompareGraphsIO(Bool_t plot_inf=kTRUE) {
  ...
  if (plot_inf) {
    ...
    legend_label = "#LT #Delta #chi^{2} #GT IO, %i PID categories";
    ...
    legend_label = "#Delta #chi^{2} IO, %i PID categories";
    legend_plotstyle = "lp";
    out_name = "fin";
  }
