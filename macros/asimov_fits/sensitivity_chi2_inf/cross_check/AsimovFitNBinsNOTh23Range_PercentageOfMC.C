...
void AsimovFitNBinsNOTh23Range_PercentageOfMC(Int_t jobnumber=0, Int_t N_PID=3) {
  ...
  TString s_outputfile = MONADIR + Form("output/csv/SensChi2Inf_20mCrossCheck/AsimovFit%iBinsNOTh23Range_PercentageOfMC/AsimovFit%iBinsNOTh23Range_PercentageOfMC_%i.csv",
