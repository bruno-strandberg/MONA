...
void FitOverEstimation3Bins() {
  ...
  tree_out.ReadFile(MONADIR + "./output/csv/CrossCheck/percentages/AsimovFit3BinsNO_PercentageOfMC/AsimovFit3BinsNO_PercentageOfMC_0-99.csv", 
                    "percentage/D:Ebins/I:ctBins/I:sens_0/D:sens_1/D:sens_2/D:fit_chi2/D", ',');
...
//  file_in.Close(); // Close the file so that RooFit can make plots on screen. (bug?)
  ...
  tree_in->ReadFile(MONADIR + "./output/csv/CrossCheck/percentages/AsimovFit3BinsNO_PercentageOfMC/AsimovFit3BinsNO_PercentageOfMC_0-99.csv", 
                    "percentage/D:Ebins/I:ctBins/I:sens_0/D:sens_1/D:sens_2/D:fit_chi2/D", ',');
