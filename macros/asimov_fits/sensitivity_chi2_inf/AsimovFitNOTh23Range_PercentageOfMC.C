 ...
 * that Nature is NO. The script takes a percentage of the MC events to map how the chi2
...
void AsimovFitNOTh23Range_PercentageOfMC(Int_t jobnumber=0) {
  ...
  TString s_outputfile = MONADIR + Form("output/csv/SensChi2Inf/AsimovFitNOTh23Range_PercentageOfMC/AsimovFitNOTh23Range_PercentageOfMC_%i.csv", jobnumber);
